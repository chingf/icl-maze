...
python train.py env.node_encoding_corr=0.25 model.n_layer=6 model.dropout=0.2 optimizer.batch_size=256 model.initialization_seed=1
python train.py env.node_encoding_corr=0.25 model.n_layer=6 model.dropout=0.2 optimizer.batch_size=256 model.initialization_seed=2
python train.py env.node_encoding_corr=0.25 model.n_layer=6 model.dropout=0.2 optimizer.batch_size=256 model.initialization_seed=3
